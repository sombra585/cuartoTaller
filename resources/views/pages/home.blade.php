    ...
    <main class="relative">
                ...
                <div class="grid lg:grid-cols-12 gap-16 items-center">
                    ...
                    <div class="lg:col-span-7">
                        ...
                        <h1 class="text-6xl lg:text-8xl font-black leading-none tracking-tighter mb-8">
                            Historias que
                            <span class="block text-emerald-400 mt-2">sobreviven</span>
                            <span class="block mt-2">a sus autores</span>
                        </h1>

                        <p class="text-gray-300 text-xl leading-relaxed max-w-2xl mb-10">
                            Un universo narrativo donde cada usuario altera el destino de una historia viva.
                        </p>
                    ...
                    <div class="lg:col-span-5">
                        ...
                        <div class="glass-panel backdrop-blur-2xl bg-[#050814]/40 border border-white/10">
                            ...
                            <div class="space-y-5">
                                ...
                                <div class="panel-row">
                                    <span class="text-gray-500">Historias activas</span>
                                ...
                                <div class="panel-row border-none">
                                    ...
                                    <span class="text-white">
                                        {{ (isset($stories) && $stories->count() > 0)
                                            ? $stories->first()->created_at->diffForHumans()
                                            : 'Sin actividad' }}
                                    </span>
                                </div>
        ...
        <section id="funcionamiento" class="max-w-7xl mx-auto px-6 py-32">
            ...
            <div class="mb-20">
                ...
                <span class="badge mb-5">SISTEMA CENTRAL</span>
                ...
                <p class="text-gray-400 text-lg max-w-2xl leading-relaxed">
                    El sistema permite crear historias vivas donde cada usuario aporta fragmentos que cambian el rumbo de la narrativa.
                </p>
            ...
            <div class="grid md:grid-cols-3 gap-10">
                ...
                <div class="glass-panel relative overflow-hidden group">
                    ...
                    <div class="relative">
                        ...
                        <h3 class="text-2xl font-black mb-4">Creación libre</h3>

                        <p class="text-gray-400 leading-relaxed">
                            Cualquier usuario puede iniciar una historia sin reglas ni límites.
                        </p>
                    </div>
                </div>
                ...
                <div class="glass-panel relative overflow-hidden group">
                    ...
                    <div class="relative">
                        ...
                        <h3 class="text-2xl font-black mb-4">Colaboración activa</h3>

                        <p class="text-gray-400 leading-relaxed">
                            Otros usuarios continúan la historia con nuevos fragmentos.
                        </p>
                    </div>
                </div>
                ...
                <div class="glass-panel relative overflow-hidden group">
                    ...
                    <div class="relative">
                        ...
                        <h3 class="text-2xl font-black mb-4">Evolución infinita</h3>

                        <p class="text-gray-400 leading-relaxed">
                            Las historias nunca terminan, se transforman constantemente.
                        </p>
                    </div>
                </div>
        ...
        <section id="historias" class="max-w-7xl mx-auto px-6 py-32 border-t border-white/5">
            ...
            <div class="flex flex-col lg:flex-row justify-between lg:items-end gap-8 mb-16">
                ...
                <div>
                    ...
                    <span class="badge mb-5">ARCHIVO GLOBAL</span>
            ...
            @if(isset($stories) && $stories->count() > 0)
                ...
                <div class="space-y-10">
                    ...
                    @foreach($stories as $index => $story)
                        ...
                        <a href="/stories/{{ $story->id }}" class="group block">
